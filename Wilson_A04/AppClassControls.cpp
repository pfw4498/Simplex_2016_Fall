...
void Application::CameraRotation(float a_fSpeed)
{
	...
	// Pass in the fAngleY to rotate vertically
	//  Pass in a negative fAngleX to move horizontally
...
#pragma region Camera Position
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::W)) {
		//Call the camera's move forward function
		// Pass in the speed
		m_pCamera->MoveForward(fSpeed);
	}
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::S)) {
		//Call the camera's move forward function
		// Pass in the negative speed to move back
		m_pCamera->MoveForward(-fSpeed);
	}
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::A)) {
		//Call the camera's move sideways function
		// Pass in the negative speed to move to the left
		m_pCamera->MoveSideways(-fSpeed);
	}
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::D)) {
		//Call the camera's move sideways function
		// Pass in the speed to move to the right
		m_pCamera->MoveSideways(fSpeed);
	}
#pragma endregion
}

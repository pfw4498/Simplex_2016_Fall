...
class Application
{
	...
	//Add lists of lists of stops (vector 3's) and path positions (uint's)
	std::vector<std::vector<vector3>> stopsList;
	std::vector<std::vector<uint>> pathsList;
	String m_sProgrammer = "Parker Wilson - pfw4498@g.rit.edu";
